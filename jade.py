   ...
   # print(population)
    ...
    for i in range(1,maxiter+1):
        ...
        for j in range(0, popsize):
            ...
            cr_j=np.random.normal(recombination,0.1)
            f_j=st.cauchy.rvs(loc=mutate,scale=0.1)
            print(f_j)
            ...
            v_donor = [x_t_i + f_j * x_diff1_i+f_j*x_diff2_i for x_t_i, x_diff1_i,x_diff2_i in zip(x_t, x_diff1,x_diff2)]
            ...
            for k in range(len(x_t)):
                ...
                if k==j_rand or random.uniform(0, 1)<cr_j:
